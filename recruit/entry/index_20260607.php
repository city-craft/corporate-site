<?php
  ...
  session_start();
  $_SESSION['formssn'] = "En6MfemTd4ogw1lrbFoArLfn";
?>
  ...
  <article>
    ...
    <section id="entryForm" class="entryForm">
      <div class="container bgPattern01 _aft">
        <p class="lead txtSet">下記フォームに必要事項をご記入の上、送信して下さい。<br class="onlypc">採用担当者からご連絡差し上げます。</p>
            ...
            <div class="formWrap">
              <dl class="formBox">
                ...
                <dd class="radioWrap">
                  ...
                  <!-- <label><input type="radio" name="type" required value="プログラム・システムエンジニア【キャリア採用枠】">プログラム・システムエンジニア【キャリア採用枠】</label> -->
                </dd>
                <dt class="req">お名前</dt>
                <dd>
